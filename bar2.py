...
bb_1um_5602 = "https://1um.brainatlas.eu/registered_sections/bigbrain/B20_5602/precomputed"

src_http = HttpAccessor(base_url=bb_1um_5602)
...
dst_acc = FileAccessor("./test_data/foo", gzip=False)
